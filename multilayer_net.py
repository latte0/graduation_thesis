...
class Net(nn.Module):
    ...
    def __init__(self, Y, calc_Y, X, calc_X, settings):
        ...
        self.test = False
        # バンド幅も推定する
        self.h = nn.Parameter(torch.tensor(6.5, requires_grad=True))
...
test_input_x = np.linspace(-100, 100, 200)
test_input_x_list = []
